...
import { complianceExtension } from "@/features/chat-compliance";
...
// Compliance is registered FIRST so its empty-state copy and suggestions win
// merge collisions with the Hedera reference extension.
const EXTENSIONS = [complianceExtension, hederaExtension];
